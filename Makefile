...
ACLOCAL = /home/bjack/gnomemeeting-0.10/missing aclocal -I macros
AUTOCONF = /home/bjack/gnomemeeting-0.10/missing autoconf
AUTOMAKE = /home/bjack/gnomemeeting-0.10/missing automake
AUTOHEADER = /home/bjack/gnomemeeting-0.10/missing autoheader
...
GNORBA_LIBS = -rdynamic -L/usr/lib -L/usr/X11R6/lib -lgnorba -lORBitCosNaming -lORBit -lIIOP -lORBitutil -lgnomeui -lart_lgpl -lgdk_imlib -lSM -lICE -lgtk -lgdk -lgmodule -lXi -lXext -lX11 -lgnome -lgnomesupport -lesd -laudiofile -lm -ldb -lglib -ldl
...
LN_S = ln -s
MAINT = #
MAKEINFO = /home/bjack/gnomemeeting-0.10/missing makeinfo
...
PACKAGE_PIXMAPS_DIR = /usr/share/pixmaps/GnomeMeeting
POFILES =  fr.po es.po
POSUB = po
...
gnomeconfdir = /usr//etc
gnomedatadir = /usr//share
l = 

SUBDIRS = macros po intl src pixmaps sounds

EXTRA_DIST =  	autogen.sh		


Applicationsdir = $(datadir)/gnome/apps/Internet
Applications_DATA = gnomemeeting.desktop
...
INSTALL Makefile.am Makefile.in TODO acconfig.h aclocal.m4 config.guess \
