 ...
 */
void gmcontacts_dnd_set_source (GtkWidget *, GmDndGetContact, gpointer);
 ...
 * PRE          : Assumes the widget and the callback are non-NULL.
 */
void gmcontacts_dnd_set_dest (GtkWidget *, GmDndPutContact, gpointer);
 ...
 */
void gmcontacts_dnd_set_dest_conditional (GtkWidget *, 
