 ...
 */
void gmtray_set_image (GmTray *tray, const gchar *image);
 ...
 */
void gmtray_blink (GmTray *tray, const gchar *blink_image, guint interval);
 ...
 * PRE         : tray shouldn't be NULL
 */
void gmtray_set_clicked_callback (GmTray *tray, void (*callback)(void));
 ...
 * PRE         : tray shouldn't be NULL
 */
void gmtray_set_menu_callback (GmTray *tray, GtkMenu *(*callback)(void));
