...
#define AUDIO_OUTPUT_PREFERRED_DEVICE_SOURCE1 "WindowsMultimedia"
#define AUDIO_OUTPUT_PREFERRED_DEVICE_NAME1   "Default"
#define AUDIO_OUTPUT_PREFERRED_DEVICE_TYPE2   "PTLIB"
#define AUDIO_OUTPUT_PREFERRED_DEVICE_SOURCE2 "WindowsMultimedia"
