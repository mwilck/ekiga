...
/*
 *                         toolbar-xml.h  -  description
 *                         ------------------------------------------
 *   begin                : written in 2007 by Julien Puydt
 *   copyright            : (c) 2007 by Julien Puydt
 *   description          : declaration of an XML-based toolbar
 *
 */

#ifndef __TOOLBAR_XML_H__
#define __TOOLBAR_XML_H__
...
namespace Ekiga
{
  ...
  public:
    ...
    ToolbarXML (ServiceCore &core,
		const std::string filename);

    ~ToolbarXML ();

    void populate (ToolbarBuilder &visitor);
