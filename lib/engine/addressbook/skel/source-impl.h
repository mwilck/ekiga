 ...
 * - or the book is considered bound to one Ekiga::Source, which will trigger its
...
namespace Ekiga {
  ...
  template<typename BookType = Book,
    ...
    public:
        ...
        typedef MapKeyReferenceIterator<BookType, connection_pair> iterator;
        typedef MapKeyConstReferenceIterator<BookType, connection_pair> const_iterator;
    ...
    protected:
         ...
         * @return: The Ekiga::Source 'book_added' signal is emitted when the Ekiga::Book
         * has been added. The Ekiga::Source 'book_updated' signal will be emitted
         * when the Ekiga::Book has been updated and the Ekiga::Source 'book_removed' signal
         * will be emitted when the Ekiga::Book has been removed from the Ekiga::Source.
         */
         ...
         * @return: The Ekiga::Source 'book_removed' signal is emitted when the Ekiga::Book
         * has been removed. The BookManagementTrait associated with the Ekiga::Source
         * will determine the memory management policy for that Ekiga::Book.
         */
    ...
    private:
        ...
        /** Disconnects the signals for the Ekiga::Book, emits the 'book_removed' signal on the 
         * Ekiga::Source and takes care of the release of that Ekiga::Book following the policy of
         * the BookManagementTrait associated with the Ekiga::Source.
         * @param: The Book to remove.
         */
        void common_removal_steps (BookType &book);


        /** This callback is triggered when the 'updated' signal is emitted on an Ekiga::Book.
         * Emits the Ekiga::Source 'book_updated' signal for that Ekiga::Book.
         * @param: The updated book.
         */
        void on_book_updated (BookType *book);


        /** This callback is triggered when the 'removed' signal is emitted on an Ekiga::Book.
         * Emits the Ekiga::Source 'book_removed' signal for that book and takes
         * care of the deletion of the book or not following the BookManagementTrait
         * associated with the Ekiga::Source.
         * @param: The updated book.
         */
        ...
        */
        std::map<BookType *, connection_pair> connections;
      };
};
...
template<typename BookType,
  typename BookManagementTrait>
void
Ekiga::SourceImpl<BookType, BookManagementTrait>::visit_books (sigc::slot<void, Book &> visitor)
{
...
{
  sigc::connection rem_conn = book.removed.connect (sigc::bind (sigc::mem_fun (this, &SourceImpl::on_book_removed), &book));
  sigc::connection upd_conn = book.updated.connect (sigc::bind (sigc::mem_fun (this, &SourceImpl::on_book_updated), &book));

  connections[&book] = connection_pair (rem_conn, upd_conn);
...
template<typename BookType,
  typename BookManagementTrait>
void
Ekiga::SourceImpl<BookType, BookManagementTrait>::common_removal_steps (BookType &book)
{
  connection_pair conns = connections[&book];
...
template<typename BookType,
  typename BookManagementTrait>
void
Ekiga::SourceImpl<BookType, BookManagementTrait>::on_book_updated (BookType *book)
{
...
template<typename BookType,
  typename BookManagementTrait>
void
Ekiga::SourceImpl<BookType, BookManagementTrait>::on_book_removed (BookType *book)
{
  common_removal_steps (*book);
