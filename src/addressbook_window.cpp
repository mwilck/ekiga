...
static void
delete_contact_dialog_run (GmAddressbook *addressbook,
                           GmContact *contact,
                   ...
                   gpointer data)
{
  ...
  delete_contact_dialog_run (abook, contact, addressbook);
                 ...
                 gpointer data)
{
  ...
  edit_contact_dialog_run (abook, contact, addressbook);
