...
void GMAudioTester::Main ()
{
  ...
  test_dialog =
    gtk_dialog_new_with_buttons ("Audio test running",
				 ...
				 NULL);
  msg = 
    g_strdup_printf (_("Ekiga is now recording from %s and playing back to %s. Please say \"1, 2, 3, Ekiga rocks!\" in your microphone. you should hear yourself from the speakers after a four-second delay."), (const char *) audio_recorder, (const char *) audio_player);
