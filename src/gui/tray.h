 ...
 *   copyright            : (C) 2000-2006 by Damien Sandras, 2002 by Miguel
 *                          Rodríguez
 ...
 * PRE          : A valid tray icon.
 */
gboolean gm_tray_is_ringing (GtkWidget *);
 ...
 * PRE          : A valid tray icon.
 */
gboolean gm_tray_is_embedded (GtkWidget *);
