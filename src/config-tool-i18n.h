...
char *s = N_("  The GConf daemon will be shut down, so make sure you have no\n  applications depending on it running.\n\n  Do you really want to do this?\n\n  If so, say \"YES\".\n\n");
char *s = N_("Shutting down GConf daemon");
char *s = N_("Removing schemas");
char *s = N_("Shutting down GConf daemon");
char *s = N_("Installing schemas");
char *s = N_("CRITICAL ERROR -- Schema installation failed.\nMost probably you have the GConf daemon running as root.\n\nRun \"gnomemeeting-config-tool --install-schemas\" as root.\n");
...
char *s = N_("  --install-schemas      install schemas with default settings (run as root)");
char *s = N_("  --clean-schemas        remove schemas with default settings (run as root)");
